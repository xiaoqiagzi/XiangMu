...
<%-- 		<div class="content mar_20">
			...
			<%-- <c:if test="${!empty(cart.map)}"> --%>
				...
				<%--		<td>
							...
							</div> ${cartItem.key}${cartItem.value.product.name}
						</td>
						...
						<td align="center">
							<div class="c_num">
								<input type="button" value="" onclick="jianUpdate1(jq(this));"
									...
									value="${cartItem.value.num}" name="" class="car_ipt" /> <input
						...
						<td align="center"><a
							href="productServlet?method=del&id=${cartItem.key}">删除</a>&nbsp;
							&nbsp;<a href="#">加入收藏</a></td> --%>
					<!-- </tr>  --> 
						</tbody>
...
<!-- 					<tr height="70">
						...
						<span class="fr">商品总价：<b style="font-size: 22px; color: #ff4e00;">¥1212</b></span>
						</td>
					</tr> -->
					...
					<tr valign="top" height="150">
						<td colspan="6" align="right"><a href="IndexQD.jsp"><img
								src="images/buy1.gif" /></a>&nbsp; &nbsp; 
								<a href="BuyCar_Two.jsp" onclick="fanhui()"><img src="images/buy2.gif" /></a></td>
					</tr> 
...
function name() {
	jq.ajax({
			url:"Shopping_cart?method=UIDShopping_cart",
			type:"POST",
			scriptCharset: "utf-8",
			success:function(data){
				var numa=0;
				var numm=0;
				var meme = jq.parseJSON(data);
				jq.each(
					meme.map,
					function(i,product){	
						jq("#idbb")
							.append("<tr>"
									...
									+"<img src='images/c_1.jpg' width='73' height='73' />"
									+"</div>"
									+"<span id='span1'>"+product.product.name+"</span>"
									+"</td>"
									+"<td align='center'></td>"
									+"<td align='center'>"
									+"<div class='c_num'>"
									+"	<input type='button' value='' onclick='jianUpdate1(jq(this));' class='car_btn_1' />"
									+"	<input type='text' value='"+product.num+"' name='' class='car_ipt' />"
									+"	<input type='button' value='' onclick='addUpdate1(jq(this));' class='car_btn_2' />"
									+"</div>"
									+"</td>"
									+"<td align='center' style='color: #ff4e00;'>￥"+product.product.price*product.num+"</td>"
									+"<td align='center'>26R</td>"
									+"<td align='center'><a href='#'>删除</a>&nbsp;&nbsp;<a href='#'>加入收藏</a>"
									+"</td>"
									+"</tr>");
						numa+=1;
						numm=numm+(product.product.price*product.num);
						
						
					});
				jq("#idmm").append("<tr height='70'>"
									+"<td colspan='6' style='font-family: 'Microsoft YaHei'; border-bottom: 0;'>"
									+"<label class='r_rad'>"
									+"<input type='checkbox' name='clear' checked='checked' />"
									+"</label>"
									+"<label class='r_txt'>清空购物车</label>"
									+"<span class='fr'>商品总价：<b style='font-size: 22px; color: #ff4e00;''>¥"+numm+"</b></span>"
									+"</td>"
									+"</tr>");
