...
<!--                 <ul class="cate_list">
                    <li>
                        ...
                        <div class="name"><a href="Product.jsp">香奈儿邂逅清新淡香水50ml</a></div>
                        <div class="carbg">
...
$(document).ready(function () {
	...
	function name() {
			$.ajax({
				url:"productServlet?method=fundAll",
				type:"POST",
				success:function(data){
					...
					$.each(
						...
						function(i,product){
							$("#idbuy")
								.append("<ul class=\"cate_list\"><li><div class=\"img\"><a href=\"productServlet?id="+product.id+"&method=findById\"><img src=\"images/per_2.jpg\" width=\"210\" height=\"185\" /></a></div><div class=\"price\"><font>￥<span>"+product.price+"</span></font> &nbsp; 26R</div><div class=\"name\"><a href=\"productServlet?id="+product.id+"&method=findById\">"+product.name+"</a></div><div class=\"carbg\"><a href=\"#\" class=\"ss\">收藏</a><a href=\"javascript:addCart("+product.id+")\" class=\"j_car\">加入购物车</a></div></li></ul>")
