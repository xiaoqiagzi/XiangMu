	...
	<div class="m_content">
		...
		<div class="m_right">
			...
			<table border="0" class="order_tab" style="width:930px; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              <tr>                                                                                                                                                    
                <td width="30%" style="color:#ff4e00; text-indent:20px;">商城网商城</td>                                                                                                                                 
                <td width="70%"><input type="text" value="<a href='http://fx.028.net/?u=76' target='_blank'>商城</a>" class="code_ipt" /> 网页签名代码</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
