...
<div class="top">
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
            ...
            <div class="price_a"><a href="productServlet?method=findCart">去购物车结算</a></div>
            <!--End 购物车已登录 End-->
        </div>
    </div>
</div>
...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div class="pro_des" id="xiangdan">
            ...
            <div class="des_join">
            	<div class="j_nums">
                	<input id="CartNum1" type="text" value="1"  name="" class="n_ipt" />
                    <input type="button" value="" onclick="addUpdate(jq(this));" class="n_btn_1" />
                    <input type="button" value="" onclick="jianUpdate(jq(this));" class="n_btn_2" />   
                </div>
                <span><a href="javascript:addCart(${product.id},${user.id})"><img src="images/j_car.png" /></a></span>
            <%-- <a href="javascript:addCart(${product.id})">加入购物车</a> --%>
            <a href="BuyCar.jsp">查询购物车</a>
           <!--  productServlet?method=findCart -->
            </div>            
        </div>  
	...
	function addCart(pid,uid) {
		$.ajax({
			url:"Shopping_cart",
			type:"POST",
			data:{"method":"addCart",uid:uid,pid:pid},
